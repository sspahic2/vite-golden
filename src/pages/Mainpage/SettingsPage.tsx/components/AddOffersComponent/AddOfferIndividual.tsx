...
import { clearCreatedError, clearCreatedStatus, createOfferIndividual } from '../../../../../redux/slices/OfferSlice'
import { toast, ToastContainer } from 'react-toastify';



const AddOfferIndividual = () => {
    ...
    const handleCreateOfferIndividual = async (e: React.FormEvent) => {
        e.preventDefault();
        ...
        await dispatch(createOfferIndividual(formData));
    };
    ...
    return (
        <>
            <ToastContainer />
            <form onSubmit={handleCreateOfferIndividual} className='mt-4 space-y-4'>
                ...
                <div className="flex items-center gap-8">
                    <label className="w-1/3 text-gray-500">PLZ</label>
                    <div className="w-2/3">
                        <input
                            type="text"
                            name="postalCode"
                        ...
                        <div className='flex flex-col space-y-4'>
                            <div className="flex items-center">
                                <input
                                    id="terms"
                                    type="checkbox"
                                    className="w-3 h-3 border-gray-300 rounded bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:ring-3 focus:ring-blue-300 dark:focus:ring-blue-600 dark:ring-offset-gray-800 checked:bg-white checked:border-black checked:ring-0"
                                />
                            ...
                            <div className="flex">
                                <input
                                    id="terms"
                                    type="checkbox"
                                    className="w-3 h-3 mt-1 border-gray-300 rounded bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:ring-3 focus:ring-blue-300 dark:focus:ring-blue-600 dark:ring-offset-gray-800 checked:bg-white checked:border-black checked:ring-0"
                                />
                                <Typography size="normal" className='ml-2'>
...
export default AddOfferIndividual
